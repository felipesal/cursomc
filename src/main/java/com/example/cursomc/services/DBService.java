...
public class DBService {
	...
	public void instantiateTestDatabase() throws ParseException {
		...
		Produto p5 = new Produto(null, "Colcha", 20.00);
		...
		cat1.getProdutos().addAll(Arrays.asList(p1, p2, p11));
		cat2.getProdutos().addAll(Arrays.asList(p2, p3));
		cat3.getProdutos().addAll(Arrays.asList(p4, p5));
		cat4.getProdutos().addAll(Arrays.asList(p1, p2, p6, p11));
		...
		Cliente cli1 = new Cliente(null, "Felipe Salles", "prof.felipe.salles@gmail.com", "36378912377", TipoCliente.PESSOAFISICA, pe.encode("123"));
		cli1.getTelefones().addAll(Arrays.asList("27363323", "93838393"));
		
		Cliente cli2 = new Cliente(null, "João Paulo", "fsreforco@gmail.com", "15673686030", TipoCliente.PESSOAFISICA, pe.encode("123"));
		cli2.getTelefones().addAll(Arrays.asList("12342123", "938383932"));
		cli2.addPerfil(Perfil.ADMIN);
		
		Endereco e1 = new Endereco(null, "Rua Flores", "300", "Apto 203", "Jardim", "38220834", cli1, c1);
		Endereco e2 = new Endereco(null, "Avenida Matos", "105", "Sala 800", "Centro", "38777012", cli1, c2);
		Endereco e3 = new Endereco(null, "Avenida Rio Branco", "2105", null, "Centro", "12777012", cli2, c2);
